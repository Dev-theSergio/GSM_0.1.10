...
import com.kbrs.app.GsmRemoteControl.R;
...
public class Fragment_2 extends Fragment {
   ...
   /* public static Fragment_2 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RadioButton radioButtonON = (RadioButton) view.findViewById(R.id.radioCycOn);
        RadioButton radioButtonOFF = (RadioButton) view.findViewById(R.id.radioCycOff);
        RadioGroup radioGroup = (RadioGroup) view.findViewById(R.id.radioGroup);
         radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){

            public void onCheckedChanged(RadioGroup group, int checkedId){
                switch (checkedId){
                    case R.id.radioCycOn:
                        break;
                    case R.id.radioCycOff:
                        break;
                }
